  ...
  async function getApiDetails(movieId) {
    ...
    try {
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/movie/${movieId}?api_key=9e5c26ddbd024153e0cbee75447bc205`
      );
      setDataDetails(data);
            ...
            <div className="row">
              <div className="col-lg-3 col-md-4 col-sm-12">
                <img
                  ...
                  src={` https://www.themoviedb.org/t/p/w300_and_h450_bestv2${dataDetails.poster_path} 
                  `}
                  alt="Atul Prajapati"
                ></img>
              </div>
